...
//  Birds
//
//  Created by shubham on 11/04/20.
...
class Popup: SKSpriteNode {
    ...
    func setupPopup(){
        ...
        let menuButton = SpriteKitButton(defaultButtonImage: "popmenu", action: popupButtonHandler(index:), index: PopupButtons.menu)
        
        let nextButton = SpriteKitButton(defaultButtonImage: "popnext", action: popupButtonHandler(index:), index: PopupButtons.next)
        
        let retryButton = SpriteKitButton(defaultButtonImage: "popretry", action: popupButtonHandler(index:), index: PopupButtons.retry)
